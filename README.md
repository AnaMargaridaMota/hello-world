...
You can either
 ...
 2. Export the project (download without a .git folder), and then rename all instances of PHDPROJECT,
 phdproject, PhDProject and the namespace vdbt with names of your choice, and then rename the top-level project folder.
...
The features provided are:
 ...
 2. A single library for the main functionality - called phdproject, so you should rename it.
...
StartVS_Debug.bat or StartVS_Release.bat in the PHDPROJECT-build folder.
